...
echo -e ""
echo -e " 3. ${BOLD}Cấu hình các tệp tin .env.local bảo mật dạng FILE Variables:${NC}"
echo -e "    - Thêm biến: ${BOLD}ENV_LOCAL_STAGING${NC} (Type: ${BOLD}File${NC}, Value: Nội dung .env.local của develop)"
echo -e "    - Thêm biến: ${BOLD}ENV_LOCAL_PRODUCTION${NC} (Type: ${BOLD}File${NC}, Value: Nội dung .env.local của main)"
echo -e "========================================================================${NC}\n"
